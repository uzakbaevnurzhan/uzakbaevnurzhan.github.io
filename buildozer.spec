...
title = Uzakbaev Nurzhan Site Monitor

# (str) Package name
package.name = uzakbaevnurzhan

# (str) Package domain (needed for android/ios packaging)
package.domain = org.uzakbaevnurzhan
...
requirements = python3,kivy,requests,beautifulsoup4,lxml,urllib3,charset-normalizer,idna,certifi
